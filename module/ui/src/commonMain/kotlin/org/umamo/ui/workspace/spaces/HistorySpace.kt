...
private fun historyStepLabel(labelKey: String?): String =
	when (labelKey) {
		...
		"change.mesh.moveUvs" -> stringResource(Res.string.history_mesh_move_uvs)
		"change.mesh.mirrorUvs" -> stringResource(Res.string.history_mesh_mirror_uvs)
		...
		"change.object.resize" -> stringResource(Res.string.history_object_resize)
