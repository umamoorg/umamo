 ...
 *   refuses an Edit-mode selection with no editable UVs and an Object-mode selection with no meshed
 *   drawable; the UV overlay then gates on its own surface).  Refusing outright is the point: the
 *   alternative would grab geometry in an area the pointer is nowhere near.
 */
