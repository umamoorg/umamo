...
fun noticeText(messageKey: String): String =
	when (messageKey) {
		...
		"notice.reload.done" -> stringResource(Res.string.notice_reload_done)
		"notice.reload.notes" -> stringResource(Res.string.notice_reload_notes)
		"notice.reload.outgrown" -> stringResource(Res.string.notice_reload_outgrown)
