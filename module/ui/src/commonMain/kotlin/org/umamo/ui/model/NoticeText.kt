...
fun noticeText(messageKey: String, arguments: List<String> = emptyList()): String =
	when (messageKey) {
		...
		"notice.document.exportingModel" -> stringResource(Res.string.notice_document_exporting_model)
		"notice.document.exportedModel" -> stringResource(Res.string.notice_document_exported_model, arguments.firstOrNull().orEmpty())
		"notice.document.exportBusy" -> stringResource(Res.string.notice_document_export_busy)
		"notice.document.waitingForExport" -> stringResource(Res.string.notice_document_waiting_for_export)
		...
		"notice.reload.notes" -> stringResource(Res.string.notice_reload_notes, *countArguments(arguments, 4))
		"notice.reload.outgrown" -> stringResource(Res.string.notice_reload_outgrown, *countArguments(arguments, 4))
		...
		"notice.match.noCandidates" -> stringResource(Res.string.notice_match_no_candidates)
		"notice.replace.done" -> stringResource(Res.string.notice_replace_done, *countArguments(arguments, 3))
