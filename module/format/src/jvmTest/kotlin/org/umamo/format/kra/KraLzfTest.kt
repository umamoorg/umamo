...
class KraLzfTest {
	...
	fun lzfDecodesALiteralRun() {
		...
		assertContentEquals("ABCD".toByteArray(Charsets.US_ASCII), output, "literal bytes copied verbatim")
	}
	...
	fun lzfDecodesAnOverlappingBackReference() {
		...
		assertContentEquals("ABABA".toByteArray(Charsets.US_ASCII), output, "overlapping copy expands run")
	}
