...
class SourceArtVisibilityTest {
	...
	fun visibleLayerWithNoGroupsIsShown() {
		val layer = FakeSourceLayer(name = "leaf", visible = true, groupPath = "")
	...
	fun hiddenLayerIsNotShownRegardlessOfGroups() {
		val layer = FakeSourceLayer(name = "leaf", visible = false, groupPath = "Folder")
	...
	fun layerInsideHiddenFolderIsNotShown() {
		val layer = FakeSourceLayer(name = "leaf", visible = true, groupPath = "Folder")
	...
	fun layerIsHiddenWhenAnyAncestorFolderIsHidden() {
		...
		val layer = FakeSourceLayer(name = "leaf", visible = true, groupPath = "A/B/C")
		val art =
			FakeArt(
				layers = listOf(layer),
				groups =
