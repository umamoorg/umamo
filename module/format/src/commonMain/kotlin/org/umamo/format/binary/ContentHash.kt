 ...
 * recognize a renamed layer whose pixels did not change.  One algorithm, named here and nowhere else:
 * SHA-256 as lowercase hex, which is what the native format persists (docs/format/UMA.md §6.4).
